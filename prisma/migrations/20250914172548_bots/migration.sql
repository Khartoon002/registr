...
INSERT INTO "new_Bot" ("createdAt", "id", "isActive", "projectId", "slug", "title", "updatedAt", "welcomeMessage") SELECT "createdAt", "id", "isActive", "projectId", "slug", "title", "updatedAt", "welcomeMessage" FROM "Bot";
DROP TABLE "Bot";
